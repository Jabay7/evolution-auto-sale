...
const base =
  "group inline-flex items-center justify-center gap-2 rounded-full text-[0.8125rem] font-medium tracking-[0.08em] uppercase transition-colors duration-300 px-7 py-4 min-h-12";
